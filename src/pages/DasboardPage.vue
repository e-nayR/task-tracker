...
const metrics = [
    ...
    {title:"Pendentes",icon_class:"bi bi-exclamation-circle text-danger",value:todo_tasks, value_class:"text-danger mb-3"},
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <tr v-for="user in users_board" :key="user.id">
                                ...
                                <td class="text-center">
                                    <span class="badge bg-danger">{{user.todo_tasks}}</span>
                                </td>
                                <td>
